<template>
  <div class="film-list">
    ...
    <div class="tabs-bar-wrapper" :class="{fixed: istabs}">
      <div class="tabs-bar">
        <ul class="tabs-nav">
          <li
            style="width: 50%;"
...
export default {
  data() {
    return {
      bannerlist: [],
      filmTypes: [
           { id: 'nowpalying', name: '正在热映', href: '/films/nowpalying' },
  ...
  methods: {
    getbanner() {
      axios
        .get("https://m.maizuo.com/gateway?type=2&cityId=310100&k=172912", {
          headers: {
            "X-Client-Info":
